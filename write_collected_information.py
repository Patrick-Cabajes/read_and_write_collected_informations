...
while True:
    while True:
        ...
        while True:
            new_entry = input("Would you like to input another entry? Please input 'yes' or 'no': ")
            if new_entry in ["yes", "no"]:
                break 
        break
    ...
    if new_entry == "yes":
        ...
        print("The data you entered has been saved to the file. The program will now close. Thank you!")
        break
